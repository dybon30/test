...
public class OrderSample extends Driver{
	...
	public void New_Order()throws Exception{
		...
		Reporter.log("Create New Order with 3 Sample Styles.");
		// newOrder(List, sample, swatch, print)
		// checkOrderFromTable(poNo, List, sample, swatch, print)
