...
public class JobTitle extends Driver{
	...
	public void AddJobTitle() throws Exception{
		...
		this.item.put("title", "Job Titles");
		this.item.put("name", "Automation Test");
		this.item.put("textFieldID", "job_title");
		this.item.put("infoField", "sync_staus_tbl_info");
		this.item.put("tableRow", "//*[@id='sync_staus_tbl']/tbody/tr/td[1]");
		this.item.put("filterField", "//*[@id='sync_staus_tbl_filter']/label/input");
	...
	@Test(priority=3)
	public void checkNewJobTitleFromUsers()throws Exception{
