...
public class TestNGCustomReport implements IReporter{
	...
	private String reportTitle= "Asher Admin Portal Automation Test";
	private String reportFileName = "test-report.html";
	...
	public void generateSuiteSummaryReport(List<ISuite> suites) {
		...
		tableColumnStart("Operating<br/>System");
		tableColumnStart("Excluded Group");
		...
		for (ISuite suite : suites) {
			...
			for (ISuiteResult r : tests.values()) {
				...
				summaryCell(overview.getCurrentXmlTest().getParameter("browser"), true);
				writer.println("</td>");
				...
				summaryCell(System.getProperty("os.name"), true);
				//summaryCell("2.33Mbps/0.78Mbps", true);
				summaryCell(overview.getExcludedGroups());
				writer.println("</tr>");
				m_testIndex++;
			}
	...
	private String getDateAsString() {
		...
		Date date = new Date();
		Date datePH = new Date(date.getTime() /*TimeUnit.HOURS.toMillis(0)*/);
		return dateFormat.format(datePH);
	}
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println(".passedodd td a{color:#ffffff}");
		out.println(".passedodd td {background-color: #06c804;color:#ffffff}");
